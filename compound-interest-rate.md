# Vulnerability Report: Interest Rate Model Issues in Compound

## Summary
The interest rate model in Compound can be manipulated through governance attacks.
